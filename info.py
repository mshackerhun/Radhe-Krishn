...
BOT_TOKEN = environ.get('BOT_TOKEN', '6931330703:AAHsBulxVBTR5jhkPc7jEp_XimU0wTN6ZMM')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/3fcca639241ecadc56b59.jpg https://graph.org/file/59e43aed4663be417314e.jpg https://graph.org/file/9403b966d3e14cf1661cf.jpg https://graph.org/file/cda7f6f0829af7b081155.jpg https://graph.org/file/799b6fba39c2623500c5e.jpg')).split() #SAMPLE PIC
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Movvies:MSMOVVIESMS@cluster0.0laqpzi.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002110388771'))
...
URL = "https://radhe-krishn-tsb3.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://radhe-krishn-tsb3.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://radhe-krishn-tsb3.onrender.com/".format(FQDN)
else:
    URL = "https://radhe-krishn-tsb3.onrender.com/".format(FQDN)
