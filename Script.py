...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/dj)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴇxᴀᴍᴘʟᴇ : ᴜɴᴄʜᴀʀᴛᴇᴅ ᴏʀ ᴜɴᴄʜᴀʀᴛᴇᴅ 2022 ᴏʀ ᴜɴᴄʜᴀʀᴛᴇᴅ ᴇɴɢʟɪsʜ

ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ 👇

ᴇxᴀᴍᴘʟᴇ : ʟᴏᴋɪ s01 ᴏʀ ʟᴏᴋɪ s01ᴇ04 ᴏʀ ʟᴜᴄɪғᴇʀ s03ᴇ24
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த @Zehrilla_Bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Add This Bot @Zehrilla_Bot As Administrator In Your Group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ @Zehrilla_Bot బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस @Zehrilla_Bot को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ @Zehrilla_Bot നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും...</b>"""
 ...
 مرحلہ 1: اپنے گروپ میں اس @Zehrilla_Bot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ @Zehrilla_Bot બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ @Zehrilla_Bot ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই @Zehrilla_Bot বট পরিচালনা করুন
